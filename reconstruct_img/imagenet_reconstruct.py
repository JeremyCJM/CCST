...
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python imagenet_reconstruct.py --dist-url 'tcp://127.0.0.1:1234' --dist-backend 'nccl' --multiprocessing-distributed --world-size 1 --rank 0 imagenet
# CUDA_VISIBLE_DEVICES=0 python imagenet_reconstruct.py imagenet --batch-size 4 --gpu 0
...
class DigitModel(nn.Module):
    ...
    def __init__(self, args,  classes=10, **kwargs):
...
def get_network(name):
    ...
    def get_network_fn(args, **kwargs):
        return nets_map[name](args, **kwargs)
